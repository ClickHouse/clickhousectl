...
# Explicitly replace a revoked/stale stored query key for only this service
clickhousectl cloud service query --id <service-id> --repair-query-key --query "SELECT 1"
