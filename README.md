...
`ServiceClickhouseSetting.value` is `Option<serde_json::Value>`: the live API returns numbers as well as strings, although its OpenAPI schema declares string ([#779](https://github.com/ClickHouse/clickhousectl/issues/779)). Values retain their JSON types; missing and null values remain absent.
