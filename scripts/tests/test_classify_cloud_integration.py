...
class CloudIntegrationClassifierTests(unittest.TestCase):
    def test_path_mapping(self):
        cases = {
            ...
            ".github/workflows/cloud-integration-decision.yml": classifier.ALL_SUITES,
            ".github/workflows/cloud-integration.yml": classifier.ALL_SUITES,
            "scripts/cloud-integration-decision.py": classifier.ALL_SUITES,
            "scripts/classify-cloud-integration.py": classifier.ALL_SUITES,
            "scripts/tests/test_cloud_integration_decision.py": classifier.ALL_SUITES,
